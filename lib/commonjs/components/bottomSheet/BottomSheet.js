...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const containerStyle = (0, _react.useMemo)(() => [_providedStyle, _styles.styles.container, {
    ...
    transform: [{
      translateY: (0, _reactNativeReanimated.cond)(animatedIsLayoutReady, (0, _reactNativeReanimated.sub)(position, bottomInset), safeContainerHeight)
    }]
  }], [safeContainerHeight, _providedStyle, position, animatedIsLayoutReady, bottomInset]);
  ...
  (0, _react.useLayoutEffect)(() => {
    if (animateOnMount && isLayoutCalculated && didMountOnAnimate.current === false && isClosing.current === false) {
